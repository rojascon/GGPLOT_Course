...

{
  ...
  isCelsius  = grep(pattern = "C|Celsius|ce|c", x=classData2$temp);
  ...
  classData2$tempValues=tempValues;
  ...
  #               F->K: K = (5/9)*(F-32) + 273
   ...
   #FARENHEIT
  classData2$FF=classData2$tempValues;
  classData2$FF[isCelsius]=((9/5)*(classData2$FF[isCelsius]))+32;
  
  #CELSIUS
  classData2$CC=(5/9)*((classData2$FF)-32);
  
  #KELVIN
  classData2$KK=classData2$CC + 273;
